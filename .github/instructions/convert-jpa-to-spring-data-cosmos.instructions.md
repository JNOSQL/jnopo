...
- **Empty/null relationship data in templates**:
  ...
  - Prevention: Never return repository results directly to templates without relationship population
...
3. **Look for SpEL template errors** in logs:
   ...
   - `EL1008E` → Service layer not populating transient properties
