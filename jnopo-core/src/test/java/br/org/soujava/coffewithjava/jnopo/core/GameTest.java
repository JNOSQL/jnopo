...
class GameTest {
    ...
    void testBehavior() {
        ...
        var gameState4 = game.playGame(gameId, player1, Movement.PAPER);
        ...
        var gameState5 = game.playGame(gameId, player1, Movement.ROCK);
        ...
        var gameState6 = game.playGame(gameId, player2, Movement.ROCK);
        ...
        var gameState7 = game.playGame(gameId, player1, Movement.SCISSORS);
        ...
        var gameState8 = game.playGame(invalidGameId, player1, Movement.ROCK);
